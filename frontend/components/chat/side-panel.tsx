...
export function SidePanel({
  ...
  const CircuitButton = ({ 
    ...
    const variantStyles = {
      ...
      danger: "bg-slate-500 hover:bg-slate-600 text-white border-slate-500 shadow-lg shadow-slate-500/25"
    };
            ...
            return (
              ...
              >
                ...
                {step.id === "upload" && uploadError && (
                  <div className="mt-1 text-xs text-slate-500 dark:text-slate-400 flex items-center space-x-1">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="p-2 bg-slate-50 dark:bg-slate-900/50 rounded border border-slate-200 dark:border-slate-700">
              ...
              <Badge variant="outline" className="text-xs font-mono h-5 px-1 w-full justify-center">
