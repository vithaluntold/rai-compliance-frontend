        ...
        <CardContent>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-white">
                <div className="text-lg font-bold text-gray-600 dark:text-gray-300">{naCount}</div>
                <div className="text-sm text-gray-700 dark:text-gray-400">Not Applicable</div>
                <ComplianceStatusIndicator
                  status="N/A"
                  showText={false}
                  className="h-8 px-2 mt-1 justify-center"
