    ...
    switch (status) {
      ...
      case "N/A":
        return {
          ...
          badge: "bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-200 border-gray-200 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-600",
  ...
  return (
    <div className={cn("space-y-2", className)}>
      ...
      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
        <div
          className="bg-blue-500 h-2 rounded-full transition-all duration-300 confidence-bar"
          ref={(el) => {
            if (el) {
              el.style.setProperty('--confidence-width', `${compliancePercentage}%`);
            }
          }}
        />
      </div>
