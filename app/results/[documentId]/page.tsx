...
export default function ComplianceChecklistPage() {
  ...
  const loadSavedAuditReview = useCallback(() => {
    try {
      ...
      // console.error("Error loading saved audit review:", error);
    }
  }, [documentId, toast]);
      ...
      <div className="max-w-full mx-auto px-6 sm:px-8 lg:px-12 py-6">
        ...
        <Card className="mb-6">
          ...
          <CardContent className="p-0">
            <Tabs defaultValue={results.sections?.[0]?.standard || results.sections?.[0]?.id} className="w-full">
                        ...
                        <div key={index} className="border rounded-lg p-6 bg-white">
                          ...
                          <div className="mb-4">
                            ...
                            <div className="w-full bg-gray-200 rounded-full h-2">
                              <div
                                className={`h-2 rounded-full ${getConfidenceColor(item.confidence || 0)}`}
