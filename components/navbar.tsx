  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center space-x-4">
        <Button className="bg-transparent" className="text-white hover:text-rai-accent">
          Sign In
        </Button>
      ...
      <Button className="bg-transparent" className="h-8 w-8" className="md:hidden text-white">
